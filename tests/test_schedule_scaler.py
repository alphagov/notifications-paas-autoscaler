...
class TestScheduleScaler:
    def test_init_assigns_basic_values(self):
        input_attrs = {"schedule": {"workdays": ["08:00-10:00"], "scale_factor": 0.4}}
    ...
    def test_get_desired_instance_count_schedule_in_gmt(self, now, expected):
        input_attrs = {"schedule": {"workdays": ["13:00-15:00"], "weekends": ["13:00-15:00"], "scale_factor": 0.6}}
    ...
    def test_disabled_schedule(self, enabled, expected):
        input_attrs = {"schedule": {"workdays": ["00:00-23:59"], "weekends": ["00:00-23:59"], "scale_factor": 0.6}}
